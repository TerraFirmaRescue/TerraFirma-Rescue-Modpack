...
mods.railcraft.RockCrusher.addRecipe(<tfctech:item.Ore:1>, true, false, [<tfctech:item.Small Ore>*5, <gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:36>, true, false, [<terrafirmacraft:item.Small Ore:1>*5, <gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:37>, true, false, [<terrafirmacraft:item.Small Ore:2>*5, <gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:39>, true, false, [<terrafirmacraft:item.Small Ore:4>*5, <gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:35>, true, false, [<terrafirmacraft:item.Small Ore>*5, <gregtech:gt.meta.dust:8500>], [1,0.2]);
...
mods.railcraft.RockCrusher.addRecipe(<tfctech:item.Ore:2>, true, false, [<tfctech:item.Small Ore>*2,<gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:50>, true, false, [<terrafirmacraft:item.Small Ore:1>*2,<gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:51>, true, false, [<terrafirmacraft:item.Small Ore:2>*2,<gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:53>, true, false, [<terrafirmacraft:item.Small Ore:4>*2,<gregtech:gt.meta.dust:8500>], [1,0.2]);
mods.railcraft.RockCrusher.addRecipe(<terrafirmacraft:item.Ore:49>, true, false, [<terrafirmacraft:item.Small Ore>*2,<gregtech:gt.meta.dust:8500>], [1,0.2]);
...
//GT Crusher recipes
MTUtilsGT.addCustomRecipe("gt.recipe.crusher", false, 16, 300, 0,[10000],
[<terrafirmacraft:item.Ore:18>],
[<gregtech:gt.meta.crushed:9159>*2,<gregtech:gt.meta.dust:8500>]);

MTUtilsGT.addCustomRecipe("gt.recipe.crusher", false, 16, 300, 0,[10000],
[<terrafirmacraft:item.Ore:19>],
[<gregtech:gt.meta.crushed:9221>*2,<gregtech:gt.meta.dust:8500>]);
